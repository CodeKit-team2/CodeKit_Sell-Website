<x-admin.profile.form.action-section>
    <x-slot name="title">
        {{ __('Browser Sessions') }}
    </x-slot>
...
{{--        @endif--}}
        ...
        <div class="flex items-center mt-5">
            ...
            <x-admin.action-message class="ml-3" on="loggedOut">
                {{ __('Done.') }}
            </x-admin.action-message>
        </div>

        <!-- Log Out Other Devices Confirmation Modal -->
{{--        <x-admin.profile.form.dialog-modal wire:model="confirmingLogout">--}}
{{--            <x-slot name="title">--}}
{{--                {{ __('Log Out Other Browser Sessions') }}--}}
{{--            </x-slot>--}}
...
{{--                <x-admin.button class="ml-2"--}}
{{--                              wire:click="logoutOtherBrowserSessions"--}}
{{--                              wire:loading.attr="disabled">--}}
{{--                    {{ __('Log Out Other Browser Sessions') }}--}}
{{--                </x-admin.button>--}}
{{--            </x-slot>--}}
{{--        </x-admin.profile.form.dialog-modal>--}}
    </x-slot>
</x-admin.profile.form.action-section>
